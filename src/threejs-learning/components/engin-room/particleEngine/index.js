...
const ParticleEngine = function ParticleEngine()
{
	/////////////////////////
	// PARTICLE PROPERTIES //
	/////////////////////////
...
ParticleEngine.prototype.initialize = function(scene)
{
  ...
  const customVisibles = new Float32Array(this.particleCount);
  const customColors = new Float32Array(this.particleCount*3);
  const customOpacitys = new Float32Array(this.particleCount);
  const customSizes = new Float32Array(this.particleCount);
  const customAngles = new Float32Array(this.particleCount);
    ...
    customVisibles[i] = this.particleArray[i].alive
    // customColors.push(this.particleArray[i].color.r,this.particleArray[i].color.g,this.particleArray[i].color.b)
    customColors[i*3] = this.particleArray[i].color.r
    customColors[i*3+1] = this.particleArray[i].color.g
    customColors[i*3+2] = this.particleArray[i].color.b
    // customOpacitys.push(this.particleArray[i].opacity)
    customOpacitys[i] = this.particleArray[i].opacity
    // customSizes.push(this.particleArray[i].size)
    customSizes[i] = this.particleArray[i].size
    // customAngles.push(this.particleArray[i].angle)
    customAngles[i] = this.particleArray[i].angle
	}

  this.particleGeometry.setAttribute('position', new THREE.BufferAttribute(positions, 3))
  this.particleGeometry.setAttribute('customVisible', new THREE.BufferAttribute(customVisibles, 1))
  this.particleGeometry.setAttribute('customColor', new THREE.BufferAttribute(customColors, 3))
  this.particleGeometry.setAttribute('customOpacity', new THREE.BufferAttribute(customOpacitys, 1))
  this.particleGeometry.setAttribute('customSize', new THREE.BufferAttribute(customSizes, 1))
  this.particleGeometry.setAttribute('customAngle', new THREE.BufferAttribute(customAngles, 1))
